...
export default function GeneralForm() {
  ...
  return (
    <section className="flex flex-col col-span-12 p-5 text-white bg-slate-900">
      <h3 className="flex justify-center pt-3 text-xl font-light ">
        General Information
      </h3>

      <form className="grid grid-cols-2 gap-3 ">
        <div className="flex flex-col gap-2 pt-3">
          <label className="text-sm text-stone-100" for="first-name">
            First Name
          </label>
          <input
        ...
        <div className="flex flex-col gap-2 pt-3">
          <label className="text-sm text-stone-200" for="last-name">
            Last Name
          </label>
          <input
            className="h-8 pl-2 text-black rounded bg-stone-200"
            id="last-name"
            placeholder="Smith"
            value={lastName}
            name="last"
        ...
        <div className="flex flex-col col-span-2 gap-2">
          ...
          <input
            id="email"
            className="h-8 pl-2 text-black rounded"
        ...
        <h3 className="flex justify-center col-span-2 pt-2 text-xl font-light">
          Address
        </h3>
        <div className="flex flex-col col-span-2 gap-2">
          <label className="text-sm" for="adress1">
            Address Line 1
          </label>
          <input
            className="h-8 pl-2 text-black rounded"
        ...
        <div className="flex flex-col col-span-2 gap-2">
          <label for="adress2" className="text-sm">
            Address Line 2
          </label>
          <input
            className="h-8 pl-2 text-black rounded"
        ...
        <div className="flex flex-col gap-2">
          <label className="text-sm" for="city">
            City
          </label>
          <input
            className="h-8 pl-2 text-black rounded"
        ...
        <div className="flex flex-col gap-2">
          <label className="text-sm" for="state">
            State
          </label>
          <select
            className="h-8 pl-2 text-black bg-white rounded"
            id="states"
            name="states"
            value={state}
        ...
        <div className="flex flex-col gap-2">
          <label className="text-sm" for="zip">
            Zip/Postal Code
          </label>
          <input
            className="h-8 pl-2 text-black rounded"
        ...
        <div className="flex flex-col gap-2">
          <label className="text-sm" for="country">
            Country
          </label>
